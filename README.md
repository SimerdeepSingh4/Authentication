# Advanced Authentication Practice

This project is a practice implementation of an advanced authentication system using Node.js, Express, and MongoDB. It includes features like user registration, login, email verification with OTP, and session management.
